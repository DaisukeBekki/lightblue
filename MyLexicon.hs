...
emptyCategories = [
  ...
  ec "come" "(154)" 100
              ...
              (verbSR 2 "来る") [("来る",nPlaceEventType 2)],
  -- サ行変格活用動詞語幹 -- とりあえずガヲ、ガヲトのパターンのみ。
  ec "\\emp" "(156)" 100
              ((defS [VS] [Stem] `BS` NP [Ga]) `BS` NP [O])
              (verbSR 2 "する") [("する", nPlaceEventType 2)],
  ...
  -- 連用節、テ節
  ec "\\emp" "new" 99
              ((T False 1 anySExStem `SL` T False 1 anySExStem) `BS` (S ([V5k, V5s, V5t, V5n, V5m, V5r, V5w, V5g, V5z, V5b, V5IKU, V5YUK, V5ARU, V5NAS, V5TOW, V1, VS, VSN, VZ]++adjective++nomPred) [Cont] [M,PM,PM,M,M]))
...
myLexicon = concat $ [
  ...
  -- adjunct:
  mylex ["へ","へは"] "(516)" ((T False 1 anySExStem `SL` T False 1 anySExStem) `BS` NP [Nc]) (adjunctCM "終点") [("終点",nPlaceEventType 1)],
  mylex ["で","では"] "(516)" ((T False 1 anySExStem `SL` T False 1 anySExStem) `BS` NP [Nc]) (adjunctCM "場所") [("場所",nPlaceEventType 1)],
  mylex ["から","からは"] "(516)" ((T False 1 anySExStem `SL` T False 1 anySExStem) `BS` NP [Nc]) (adjunctCM "始点") [("始点",nPlaceEventType 1)],
  mylex ["まで","までは"] "(516)" ((T False 1 anySExStem `SL` T False 1 anySExStem) `BS` NP [Nc]) (adjunctCM "終点") [("終点",nPlaceEventType 1)], 
  mylex ["より","よりは"] "(516)" ((T False 1 anySExStem `SL` T False 1 anySExStem) `BS` NP [Nc]) (adjunctCM "起点") [("起点",nPlaceEventType 1)], 
  mylex ["にて"] "(516)" ((T False 1 anySExStem `SL` T False 1 anySExStem) `BS` NP [Nc]) (adjunctCM "場所") [("場所",nPlaceEventType 1)], 
  -- 格助詞（の）
  ...
  mylex ["いらっしゃ"] "(122)" (defS [V5NAS] [Stem] `BS` NP [Ga]) (verbSR 1 "来る") [("来る",nPlaceEventType 1)],
  mylex ["いらっしゃ"] "(122)" (defS [V5NAS] [Stem] `BS` defS anyPos [TeForm]) (eventModifier "来る") [("来る",eventModifierType)],
  mylex ["仰","おっしゃ"] "(122)" ((defS [V5NAS] [Stem] `BS` NP [Ga]) `BS` Sbar [ToCL]) (verbSR 2 "言う") [("言う",nPlaceEventType 2)],
  mylex ["下さ","くださ"] "(122)" (((defS [V5NAS] [Stem] `BS` NP [Ga]) `BS` NP [Ni]) `BS` NP [O]) (verbSR 3 "クレル") [("クレル",nPlaceEventType 3)],
  mylex ["下さ","くださ"] "(122)" (defS [V5NAS] [Stem] `BS` defS anyPos [TeForm]) (eventModifier "クレル") [("クレル",eventModifierType)],
  mylex ["ござ","御座"] "(122)" (defS [V5NAS] [Stem] `BS` defS anyPos [Cont]) id [],
  -- 例外的な命令形
  mylex ["くれ"] "(149)" (((defS [V1] [Imper] `BS` NP [Ga]) `BS` NP [Ni]) `BS` NP [O]) (verbSR 3 "くれる") [("くれる",nPlaceEventType 3)],
  mylex ["くれ"] "(150)" (defS [V1] [Imper] `BS` S verb [TeForm] [M,M,PM,M,M]) id [],
  mylex ["射れ","いれ"] "(151)" ((defS [V5r] [Imper] `BS` NP [Ga]) `BS` NP [O]) (verbSR 2 "射る") [("射る",nPlaceEventType 2)],
  mylex ["蹴ろ","けろ"] "(152)" ((defS [V1] [Imper] `BS` NP [Ga]) `BS` NP [O]) (verbSR 2 "蹴る") [("蹴る",nPlaceEventType 2)],
  mylex ["捻ろ","ひねろ"] "(153)" ((defS [V1] [Imper] `BS` NP [Ga]) `BS` NP [O]) (verbSR 2 "捻る") [("捻る",nPlaceEventType 2)],
  --- カ変動詞
  ...
  --- ウル型活用動詞
  mylex ["得る","うる"] "(169)" ((defS [VURU] [Term,Attr] `BS` NP [Ga]) `BS` NP [O]) (verbSR 2 "得る") [("得る",nPlaceEventType 2)],
  -- 形容詞活用語尾
  ...
  -- ナシ型活用形容詞
  mylex ["良","よ"] "(173)" (defS [ANAS] [Stem,UStem] `BS` NP [Ga]) (predSR 1 "良い") [("良い",nPlaceStateType 1)],
  mylex ["無","な"] "(173)" (S [ANAS] [Stem] [M,M,P,M,M] `BS` NP [Ga]) (predSR 1 "無い") [("無い",nPlaceStateType 1)], --  +nとした
  mylex ["無","な"] "(173)+" ((S [ANAS] [Stem] [M,M,P,M,M] `BS` NP [Ga]) `BS` NP [Ni]) (predSR 2 "無い") [("無い",nPlaceStateType 2)],
  mylex ["無","の"] "(173)" (S [ANAS] [UStem] [M,M,P,M,M] `BS` NP [Ga]) (predSR 1 "無い") [("無い",nPlaceStateType 1)], -- +nとした
  -- チイ形活用形容詞
  mylex ["弱っち","よわっち"] "(196)" (defS [ATII] [Stem] `BS` NP [Ga]) (predSR 1 "弱っちい")  [("弱っちい",nPlaceStateType 1)],
  mylex ["ちゃち"]           "(196)" (defS [ATII] [Stem] `BS` NP [Ga]) (predSR 1 "ちゃちい") [("ちゃちい",nPlaceStateType 1)],
  mylex ["ばばっち","ばばち"] "(196)" (defS [ATII] [Stem] `BS` NP [Ga]) (predSR 1 "ばばちい") [("ばばちい",nPlaceStateType 1)],
  mylex ["ぼろっち","ぼろち"] "(196)" (defS [ATII] [Stem] `BS` NP [Ga]) (predSR 1 "ぼろちい") [("ぼろちい",nPlaceStateType 1)],
  mylex ["みみっち","みみち"] "(196)" (defS [ATII] [Stem] `BS` NP [Ga]) (predSR 1 "みみっちい") [("みみっちい",nPlaceStateType 1)],
  -- ベシ形活用形容詞
  mylex ["如","ごと"] "(199)" ((defS [ABES] [Stem] `BS` NP [Ga]) `BS` NP [Ga,No]) (verbSR 2 "如し")  [("如し",nPlaceStateType 2)],
  mylex ["如","ごと"] "(199)" (defS [ABES] [Stem] `BS` defS anyPos [Attr]) (verbSR 2 "如し") [("如し",nPlaceStateType 2)],
  mylex ["べ"] "(200)" (defS [ABES] [Stem] `BS` defS verb [Term]) (modal "べし")  [("べし",modalType)],
  -- 形容詞派生形
  ...
  -- 助動詞（過去）
  mylex ["たり"] "(308)" (S anyPos [Cont] [P,(F 1 PM),(F 2 PM),M,M] `BS` S anyPos [EuphT] [M,(F 1 PM),(F 2 PM),M,M])     (eventModifier "タ[MCN]") [("タ[MCN]",eventModifierType)],
  mylex ["た"] "(308)"  (S anyPos [Term,Attr] [P,(F 1 PM),(F 2 PM),M,M] `BS` S anyPos [EuphT] [M,(F 1 PM),(F 2 PM),M,M]) (eventModifier "タ[MCN]") [("タ[MCN]",eventModifierType)],
  mylex ["たら"] "(308)" (S anyPos [Hyp] [P,(F 1 PM),(F 2 PM),M,M] `BS` S anyPos [EuphT] [M,(F 1 PM),(F 2 PM),M,M])      (eventModifier "タ[MCN]") [("タ[MCN]",eventModifierType)],
  mylex ["たろ"] "(308)" (S anyPos [ModU] [P,(F 1 PM),(F 2 PM),M,M] `BS` S anyPos [EuphT] [M,(F 1 PM),(F 2 PM),M,M])     (eventModifier "タ[MCN]") [("タ[MCN]",eventModifierType)],
  mylex ["だり"] "(309)" (S verb [Cont] [P,M,(F 1 PM),M,M] `BS` S verb [EuphD] [M,M,(F 1 PM),M,M])     (eventModifier "タ[MCN]")  [("タ[MCN]",eventModifierType)],
  mylex ["だ"] "(309)" (S verb [Term,Attr] [P,M,(F 1 PM),M,M] `BS` S verb [EuphD] [M,M,(F 1 PM),M,M])  (eventModifier "タ[MCN]") [("タ[MCN]",eventModifierType)],
  mylex ["だら"] "(309)" (S verb [Hyp] [P,M,(F 1 PM),M,M] `BS` S verb [EuphD] [M,M,(F 1 PM),M,M])      (eventModifier "タ[MCN]") [("タ[MCN]",eventModifierType)],
  mylex ["だろ"] "(309)" (S verb [ModU] [P,M,(F 1 PM),M,M] `BS` S verb [EuphD] [M,M,(F 1 PM),M,M])     (eventModifier "タ[MCN]") [("タ[MCN]",eventModifierType)],
  -- 助動詞（丁寧）
  ...
  mylex ["ませ"]   "(311)" (S verb [NegL] [M,P,M,M,M] `BS` defS verb [Cont])        id [],
 ...
 -- 助動詞（否定）
  ...
  mylex ["まい"] "(359a)" (S verb [Pre] [M,(F 1 PM),P,M,M] `BS` S verb [Term] [M,(F 1 PM),M,M,M])
                         (Lam (Lam (App (Con "ダロウ[MCN]") (Not (App (Var 1) (Var 0)))))) [("ダロウ[MCN]",modalType)],
  ...
  -- 動詞性接尾語
  -- 6.1.1 形式述語 
  mylex ["居","い"] "(381)" (defS [V1] [Stem,Neg,Cont,NegL,EuphT] `BS` defS verb [TeForm,NiForm]) (eventModifier "テイル[ASP]") [("テイル[ASP]",eventModifierType)],
  mylex ["あ"] "(381)" (defS [V5ARU] [Stem] `BS` defS verb [TeForm]) (eventModifier "テアル[ASP]") [("テアル[ASP]",eventModifierType)],
  mylex ["あ"] "(381)" (defS [V5ARU] [Stem] `BS` defS adjective [Cont]) (eventModifier "テアル[ASP]") [("テアル[ASP]",eventModifierType)],
  ...
  mylex ["な"] "(384)" ((defS [V5r] [Stem] `BS` NP [Ga]) `BS` (defS adjective [Cont] `BS` NP [Ga])) (intensionalEvent 1 "成る") [("成る",intensionalEventType)],
  mylex ["な"] "(384)" ((defS [V5r] [Stem] `BS` NP [Ga]) `BS` (defS [Nda] [NiForm] `BS` NP [Ga])) (intensionalEvent 1 "成る") [("成る",intensionalEventType)],
  -- い省略
  mylex ["て"] "(403)" (defS [V1] [Stem,Neg,Cont,NegL,EuphT] `BS` defS verb [EuphT]) (eventModifier "テイル[ASP]") [("テイル[ASP]",eventModifierType)],
  -- 取り立て（副助詞）
  ...
  --mylex ["とて"]
  -- 6.1.3 補助動詞（連用形接続）
  mylex ["始め","はじめ"] "(412)" (defS [V1] [Stem,Neg,Cont,NegL,EuphT] `BS` defS verb [Cont]) (eventModifier "始める") [("始める",eventModifierType)],
  mylex ["込","こ"] "(412)" (defS [V5m] [Stem] `BS` defS verb [Cont])                         (eventModifier "込む") [("込む",eventModifierType)],
  mylex ["出","だ"] "(412)" (defS [V5s] [Stem] `BS` defS verb [Cont])                         (eventModifier "出す") [("出す",eventModifierType)],
  mylex ["合","あ"] "(412)" (defS [V5w] [Stem] `BS` defS verb [Cont])                         (eventModifier "合う") [("合う",eventModifierType)],
  mylex ["続け","つづけ"] "(412)" (defS [V1] [Stem,Neg,Cont,NegL,EuphT] `BS` defS verb [Cont]) (eventModifier "続ける") [("続ける",eventModifierType)],
  mylex ["かけ"] "(412)" (defS [V1] [Stem,Neg,Cont,NegL,EuphT] `BS` defS verb [Cont])         (eventModifier "かける") [("かける",eventModifierType)],
  mylex ["上げ","あげ"] "(412)" (defS [V1] [Stem,Neg,Cont,NegL,EuphT] `BS` defS verb [Cont])   (eventModifier "上げる") [("上げる",eventModifierType)],
  mylex ["切","き"] "(412)" (defS [V5r] [Stem] `BS` defS verb [Cont])                         (eventModifier "切る") [("切る",eventModifierType)],
  mylex ["付け","つけ"] "(412)" (defS [V1] [Stem,Neg,Cont,NegL,EuphT] `BS` defS verb [Cont])   (eventModifier "付ける") [("付ける",eventModifierType)],
  mylex ["過ぎ","すぎ"] "(412)" (defS [V1] [Stem,Neg,Cont,NegL,EuphT] `BS` defS verb [Cont])   (eventModifier "過ぎる") [("過ぎる",eventModifierType)],
  mylex ["あぐ"] "(412)" (defS [V5m] [Stem] `BS` defS verb [Cont])                            (eventModifier "あぐむ") [("あぐむ",eventModifierType)],
  mylex ["かね"] "(412)" (defS [V1] [Stem,Neg,Cont,NegL,EuphT] `BS` defS verb [Cont])         (eventModifier "かねる") [("かねる",eventModifierType)],
  mylex ["やが"] "(412)" (defS [V5r] [Stem] `BS` defS verb [Cont])                            (eventModifier "やがる") [("やがる",eventModifierType)],
  -- 6.1.4 補助動詞（テ形接続）
  mylex ["お"] "(416)" (defS [V5k] [Stem] `BS` defS verb [TeForm])        (eventModifier "テオク[ASP]") [("テオク[ASP]",eventModifierType)],
  mylex ["仕舞","しま"] "(416)" (defS [V5w] [Stem] `BS` defS verb [TeForm]) (eventModifier "テシマウ[ASP]") [("テシマウ[ASP]",eventModifierType)],
  mylex ["行","い"] "(416)" (defS [V5k] [Stem] `BS` defS verb [TeForm])    (eventModifier "テイク[ASP]") [("テイク[ASP]",eventModifierType)],
  mylex ["見","み"] "(416)" (defS [V1] [Stem,Neg,Cont,NegL,EuphT] `BS` defS verb [TeForm])     (eventModifier "テミル[ASP]") [("テミル[ASP]",eventModifierType)],
  mylex ["見せ","みせ"] "(416)" (defS [V1] [Stem,Neg,Cont,NegL,EuphT] `BS` defS verb [TeForm]) (eventModifier "テミセル[ASP]") [("テミセル[ASP]",eventModifierType)],
  mylex ["ちゃ","ちま"] "(426)" (defS [V5w] [Stem] `BS` defS verb [EuphT]) (eventModifier "テシマウ[ASP]") [("テシマウ[ASP]",eventModifierType)],
  mylex ["じゃ","じま"] "(427)" (defS [V5w] [Stem] `BS` defS verb [EuphD]) (eventModifier "テシマウ[ASP]") [("テシマウ[ASP]",eventModifierType)],
  ...
  mylex ["上げ","あげ"] "(436)" ((defS [V1] [Stem,Neg,Cont,NegL,EuphT] `BS` NP [Ga]) `BS` (defS verb [TeForm] `BS` NP [Ga]))
        (Lam (Lam (Lam (App (Con "アゲル") (Pair (Var 1) (App (App (Var 2) (Var 1)) (Var 0))))))) [("アゲル",Type)],
  ...
  -- 6.1.6 −がる
  mylex ["が"] "(443)" ((defS [V5r] [Stem] `BS` NP [Ga]) `BS` (defS [Aauo,Ai,ANAS] [Stem] `BS` NP [Ga])) (intensionalEvent 1 "ガル") [("ガル",Type)],
  -- 6.1.7 −めく
  mylex ["め"] "(453)" ((defS [V5k] [Stem] `BS` NP [Ga]) `BS` N) (Lam (Lam (Lam (App (Con "メク") (Pair (Var 0) (App (App (Var 2) (Var 1)) (Var 0))))))) [("メク",Type)], -- to be revised
  -- 形容詞性接尾語
  -- 6.2.1 ない
  mylex ["な"] "(455)" (S [ANAS] [Stem] [M,M,P,M,M] `BS` S anyPos [Neg] [M,M,PM,PM,M]) negOperator [],
  mylex ["無","な"] "(458)" (S [Aauo,ANAS] [Stem] [M,M,P,M,M] `BS` NP [Ga]) (predSR 1 "無い") [("無い",nPlaceStateType 1)],
  mylex ["ねえ","ねぇ","ねー"] "(455)" (S [ANAS] [Term,Attr] [M,M,P,M,M] `BS` defS anyPos [Neg]) negOperator [],
  mylex ["ねえ","ねぇ","ねー"] "(458)" (S [Aauo,ANAS] [Term,Attr] [M,M,P,M,M] `BS` NP [Ga]) (predSR 1 "無い") [("無い",nPlaceStateType 1)],
  mylex ["無し","なし","ナシ"] "(467)" (S [Nda,Nno,Nni] [Stem] [M,M,P,M,M] `BS` NP [Ga])    (predSR 1 "無い") [("無い",nPlaceStateType 1)],
  -- 6.2.2 たい
  ...
  -- 6.2.3-6.2.6
  mylex ["らし"] "(478)" (defS [Ai] [Stem] `BS` defS verb [Term])      (modal "ラシイ[MCN]") [("ラシイ[MCN]",modalType)],
  mylex ["らし"] "(478)" (defS [Ai] [Stem] `BS` defS adjective [Term]) (modal "ラシイ[MCN]") [("ラシイ[MCN]",modalType)],
  mylex ["らし"] "(478)" (defS [Ai] [Stem] `BS` defS [Nda] [Stem])     (modal "ラシイ[MCN]") [("ラシイ[MCN]",modalType)],
  mylex ["っぽ"] "(480)" (defS [Aauo] [Stem] `BS` defS [Aauo,Nda] [Stem]) (modal "ポイ[MCN]") [("ポイ[MCN]",modalType)],
  mylex ["くさ"] "(478)" (defS [Ai] [Stem] `BS` defS verb [Term])         (modal "クサイ[MCN]") [("クサイ[MCN]",modalType)],
  mylex ["くさ"] "(478)" (defS [Ai] [Stem] `BS` defS adjective [Term])    (modal "クサイ[MCN]") [("クサイ[MCN]",modalType)],
  mylex ["くさ"] "(478)" (defS [Ai] [Stem] `BS` defS [Nda] [Stem])       (modal "クサイ[MCN]") [("クサイ[MCN]",modalType)],
  mylex ["べき"] "(488)" (defS [Nda] [Attr] `BS` defS verb [Term])       (modal "ベキ[MCN]") [("ベキ[MCN]",modalType)],
  -- 状詞性接尾語
  mylex ["よう"] "(493)" (defS [Nda,Nna,Nni] [Stem] `BS` defS anyPos [Attr]) (modal "ヨウダ[MCN]") [("ヨウダ[MCN]",modalType)],
  mylex ["そう"] "(497)" (defS [Nda] [Stem] `BS` defS anyPos [Term])         (modal "ソウダ伝聞[MCN]") [("ソウダ伝聞[MCN]",modalType)],
  mylex ["そう"] "(498)" (defS [Nda,Nna,Nni] [Stem] `BS` defS anyPos [ModS]) (modal "ソウダ推量[MCN]") [("ソウダ推量[MCN]",modalType)],
  mylex ["がち"] "(506)" (defS [Nda,Nna,Nni] [Stem] `BS` defS anyPos [Cont]) (modal "ガチダ[MCN]") [("ガチダ[MCN]",modalType)],
  mylex ["みたい"] "(507)" (defS [Nda,Nna,Nni] [Stem] `BS` defS verb [Term]) (modal "ミタイダ[MCN]") [("ミタイダ[MCN]",modalType)],
  mylex ["みたい"] "(507)" (defS [Nda,Nna,Nni] [Stem] `BS` defS adjective [Term]) (modal "ミタイダ[MCN]") [("ミタイダ[MCN]",modalType)],
  mylex ["みたい"] "(507)" (defS [Nda,Nna,Nni] [Stem] `BS` defS [Nda] [Stem]) (modal "ミタイダ[MCN]") [("ミタイダ[MCN]",modalType)],
  ...
  mylex ["なの"] "(510)" (defS [Nda] [Stem] `BS` defS [Nda] [Stem])          (modal "ナノダ[MCN]") [("ナノダ[MCN]",modalType)],
  mylex ["の","ん"] "(511)" (defS [Nda] [Stem] `BS` S anyPos [Attr] [M,M,M,PM,M])           (modal "ノダ[MCN]") [("ノダ[MCN]",modalType)],
  mylex ["筈","はず","ハズ"] "(511)" (defS [Nda] [Stem] `BS` defS anyPos [Attr]) (modal "ハズダ[MCN]") [("ハズダ[MCN]",modalType)],
  mylex ["訳","わけ","ワケ"] "(511)" (defS [Nda] [Stem] `BS` defS anyPos [Attr]) (modal "ワケダ[MCN]") [("ワケダ[MCN]",modalType)],
  mylex ["つもり"] "new" (defS [Nda] [Stem] `BS` defS anyPos [Attr]) (modal "ツモリ[MCN]") [("ツモリ[MCN]",modalType)],
  mylex ["もの","もん"] "(511)" (defS [Nda] [Stem] `BS` defS anyPos [Attr])            (modal "モノダ[MCN]") [("モノダ[MCN]",modalType)],
  -- べきだ
  -- ふうだ
  -- ことだ
  -- ばかりだ、ばっかりだ、ばっかだ、
  ...
  -- 連体詞
  mylex ["こう"] "new" (anySExStem `SL` anySExStem) (eventModifier "こう") [("こう",eventModifierType)],
  mylex ["そう"] "new" (anySExStem `SL` anySExStem) (eventModifier "そう") [("そう",eventModifierType)],
  mylex ["ああ"] "new" (anySExStem `SL` anySExStem) (eventModifier "ああ") [("ああ",eventModifierType)],
  mylex ["どう"] "new" (anySExStem `SL` anySExStem) (eventModifier "どう") [("どう",eventModifierType)],
  ...
  -- Wh句
  mylex ["誰","だれ"] "new" (NP [Nc]) (Con "誰") [("誰",(Con "entity"))],
  mylex ["何","なに"] "new" (NP [Nc]) (Con "何") [("何",(Con "entity"))],
  mylex ["何処","どこ"] "new" (NP [Nc]) (Con "どこ") [("どこ",(Con "entity"))],
  -- 従属節導入表現
  ...
  --- とする
  mylex ["と"] "new" ((defS [VS] [Stem]) `BS` (S anyPos [Pre] [PM,PM,PM,M,M])) (modal "トスル[MCN]") [("トスル[MCN]",modalType)],
  -- 連用節
  ...
  mylex [")","]","−","-"] "new" RPAREN Unit [],
  -- 形式名詞
  mylex ["こと","事"] "new" ((T True 1 anySExStem `SL` (T True 1 anySExStem `BS` NP [Nc])) `BS` (S anyPos [Attr] [PM,PM,PM,M,M])) (Lam (Lam (Lamvec (Sigma (Con "entity") (Sigma (Sigma (Con "state") (App (App (Con "こと") (Var 1 )) (Var 0))) (Sigma (App (App (Con "content") (App (Var 4) (Lam Top))) (Var 1)) (Appvec 3 (App (Var 4) (Var 2))))))))) [("こと",Type),("content",Type)],
  mylex ["の"] "new" ((T True 1 anySExStem `SL` (T True 1 anySExStem `BS` NP [Nc])) `BS` (S anyPos [Attr] [PM,PM,PM,M,M])) (Lam (Lam (Lamvec (Sigma (Con "entity") (Sigma (Sigma (Con "state") (App (App (Con "の") (Var 1 )) (Var 0))) (Sigma (App (App (Con "content") (App (Var 4) (Lam Top))) (Var 1)) (Appvec 3 (App (Var 4) (Var 2))))))))) [("の",Type),("content",Type)],
  -- 量化表現：Q-no N
