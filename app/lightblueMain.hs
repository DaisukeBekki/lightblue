      ...
      case style of
        ...
        _ -> do
          ...
          pairs <- forM parsedJSeM'' $ \j -> do
            ...
            S.putStr "\n"
            let sentences = postpend (map T.fromStrict $ J.premises j) (T.fromStrict $ J.hypothesis j)
                parseResult = NLI.parseWithTypeCheck parseSetting prover [("ap",DTT.Pi DTT.Entity (DTT.Pi DTT.Entity (DTT.Pi (DTT.App (DTT.App (DTT.Con "AP") (DTT.Var 1)) (DTT.Var 2)) (DTT.App (DTT.App (DTT.Con "woman") (DTT.Var 1)) (DTT.Var 2))))), ("p",DTT.Pi DTT.Entity (DTT.Pi DTT.Entity (DTT.Pi (DTT.App (DTT.App (DTT.Con "professor") (DTT.Var 1)) (DTT.Var 2)) (DTT.App (DTT.App (DTT.Con "woman") (DTT.Var 1)) (DTT.Var 2)))))] [] sentences
