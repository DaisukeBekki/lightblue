...
%2006.12.17.revised
alphaConvert(Expression,Sub,Free1-Free2,one(Y,F2)):- 
   nonvar(Expression),
   Expression = one(X,F1),
   alphaConvert(F1,[sub(X,Y)|Sub],Free1-Free2,F2).

alphaConvert(Expression,Sub,Free1-Free2,two(Y,F2)):- 
   nonvar(Expression),
   Expression = two(X,F1),
   alphaConvert(F1,[sub(X,Y)|Sub],Free1-Free2,F2).

alphaConvert(Expression,Sub,Free1-Free2,three(Y,F2)):- 
   nonvar(Expression),
   Expression = three(X,F1),
   alphaConvert(F1,[sub(X,Y)|Sub],Free1-Free2,F2).
