...
noanswer=`cat ${input} | grep -v undef | awk '$3 == "/td" || $3 == "error" || $3 == "/a"' | wc -l`
correct_parsing=`cat ${input} | grep -v undef | awk '$3 != "/td"' | awk '$3 != "error"' | awk '$3 != "/a"' | wc -l`
...
yes_error=`cat ${input} | awk '$2 == "yes" && ($3 == "/td" || $3 == "error" || $3 == "/a")' | wc -l`
...
no_error=`cat ${input} | awk '$2 == "no" && ($3 == "/td" || $3 == "error" || $3 == "/a")' | wc -l`
...
unk_error=`cat ${input} | awk '$2 == "unknown" && ($3 == "/td" || $3 == "error" || $3 == "/a")' | wc -l`
