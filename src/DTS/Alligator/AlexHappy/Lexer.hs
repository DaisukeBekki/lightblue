...
alex_table = listArray (0 :: Int, 1038)
  [ 0
  , 30
  , 29
  , 30
...
alex_check = listArray (0 :: Int, 1038)
  [ -1
  , 9
  , 10
  , 11
...
{-# LINE 74 "DTS/Alligator/AlexHappy/Lexer.x" #-}
...
alex_action_17 =  \s -> TokenPreNum
alex_action_18 =  \s -> TokenNum (read s) 
