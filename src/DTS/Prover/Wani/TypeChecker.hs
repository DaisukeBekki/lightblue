...
-- -- (Asp)は変換先がないので、[]が返る(?)
-- transP :: (UDdB.Preterm UDdB.UDTT) -> [(UDdB.Preterm UDdB.DTT)]
-- transP udtt = M.maybe [] (:[]) (UDdB.toDTT udtt)
...
-- --   preterm <- transP preM
-- --   if selector == {--  UD.Fst --} UDdB.Fst
-- --     then do return (DT.Proj {--  DT.Fst --} UDdB.Fst preterm)
-- --     else do return (DT.Proj {--  DT.Snd --} UDdB.Snd preterm)
-- -- transP {--  UD.Type --} UDdB.Type = [{--  DT.Type --} UDdB.Type]
-- -- transP {--  UD.Kind --} UDdB.Kind = [{--  DT.Kind --} UDdB.Kind]
...
-- repositP :: (UDdB.Preterm UDdB.DTT) -> (UDdB.Preterm UDdB.UDTT)
-- repositP = UDdB.toUDTT
...
--   if (label == TypeF && (preV /= {--  UD.Type --} UDdB.Type || preM /= {--  UD.Kind --} UDdB.Kind))
--       || (label == CON&& (case preV of UD.Con _ -> False ; _ -> True))
--       || (label == TopF && (preV /= UD.Top || preM /= {--  UD.Type --} UDdB.Type))
--       || (label == TopI && (preV /= UD.Unit || preM /= UD.Top))
--       || (label == BotF && (preV /= UD.Bot || preM /= {--  UD.Type --} UDdB.Type))
...
--                         (DT.Sigma preA _, UD.Proj {--  UD.Fst --} UDdB.Fst _) ->
--                           Just (DT.Proj {--  DT.Fst --} UDdB.Fst $head upsideTerms',preA)
--                         (DT.Sigma _ preB, UD.Proj {--  UD.Snd --} UDdB.Snd _) ->
--                           Just (DT.Proj {--  DT.Snd --} UDdB.Snd $head upsideTerms',preB)
--                         _ -> Nothing
...
-- typeCheckU :: TUEnv -> SUEnv -> (UDdB.Preterm UDdB.UDTT) -> (UDdB.Preterm UDdB.UDTT) -> [UTree UJudgement]
-- -- (ΠI) rule
-- typeCheckU typeEnv sig (UD.Lam preM) (UD.Pi preA preB) = do
--   leftTree <- (typeCheckU typeEnv sig preA ({--  UD.Type --} UDdB.Type))
--                 ++ (typeCheckU typeEnv sig preA ({--  UD.Kind --} UDdB.Kind))
...
--   leftTree <- (typeCheckU typeEnv sig preterm {--  UD.Type --} UDdB.Type)
--                 ++ (typeCheckU typeEnv sig preterm {--  UD.Kind --} UDdB.Kind)
--   newleftTree <- aspElim leftTree
--   newA <- getTerm newleftTree
--   let preA' = UD.betaReduce $ repositP newA
...
--     else if value == {--  UD.Kind --} UDdB.Kind
--       then []
--       else do return (UError' (UJudgement typeEnv value resultType) (T.pack "does not match type"))

-- -- | typeInferU : UDTTの型推論
-- typeInferU :: TUEnv -> SUEnv -> (UDdB.Preterm UDdB.UDTT) -> [UTree UJudgement]
-- -- (typeF) rule
-- typeInferU typeEnv _ {--  UD.Type --} UDdB.Type =
--   return $ UT (L TypeF) (UJudgement typeEnv {--  UD.Type --} UDdB.Type {--  UD.Kind --} UDdB.Kind) []
-- -- (VAR) rule
...
--   return (UT (L TopF) (UJudgement typeEnv UD.Top {--  UD.Type --} UDdB.Type) [])
-- -- (TopI) rule
-- typeInferU typeEnv _ UD.Unit =
--   return (UT (L TopI) (UJudgement typeEnv UD.Unit UD.Top) [])
-- -- (BotF) rule
-- typeInferU typeEnv _ UD.Bot =
--   return (UT (L BotF) (UJudgement typeEnv UD.Bot {--  UD.Type --} UDdB.Type) [])
-- -- (ΠF) rule
...
--   newA <- getTerm newleftTree
--   let preA' = UD.betaReduce $ repositP newA
--   rightTree <- (typeCheckU (preA':typeEnv) sig preB {--  UD.Type --} UDdB.Type)
--                  ++ (typeCheckU (preA':typeEnv) sig preB {--  UD.Kind --} UDdB.Kind)
...
--           case bodyType of
--             (UD.Sigma preA _) ->
--                return (UT (L SigE) (UJudgement typeEnv (UD.Proj {--  UD.Fst --} UDdB.Fst preM) preA) [overTree])
--             _ -> return (UError' (UJudgement typeEnv (UD.Proj {--  UD.Fst --} UDdB.Fst preM) (UD.Con $ T.pack "???")) (T.pack "Not a Sigma type"))
--   else do overTree <- typeInferU typeEnv sig preM
--           bodyType <- getTypeU overTree
--           case bodyType of
--             (UD.Sigma _ preB) -> do
--                let preB' = UD.betaReduce $ UD.shiftIndices (UD.subst preB (UD.shiftIndices (UD.Proj {--  UD.Fst --} UDdB.Fst preM) 1 0) 0) (-1) 0
--                return (UT (L SigE) (UJudgement typeEnv (UD.Proj {--  UD.Snd --} UDdB.Snd preM) preB') [overTree])
--             _ -> do return (UError' (UJudgement typeEnv (UD.Proj {--  UD.Snd --} UDdB.Snd preM) (UD.Con $ T.pack "???")) (T.pack "Not a Sigma type"))
-- -- UD.subst preB (UD.Proj {--  UD.Fst --} UDdB.Fst preM) 0
-- -- (Asp) rule
...
-- --  return (UDREL (UJudgement typeEnv (UD.DRel i t preM preN) {--  UD.Type --} UDdB.Type))
-- -- otherwise
-- typeInferU _ _ _ = []


-- proofSearch :: TUEnv -> SUEnv -> (UDdB.Preterm UDdB.UDTT) -> [UTree UJudgement]
...
-- sigIntro :: TUEnv -> SUEnv -> [((UDdB.Preterm UDdB.UDTT), (UDdB.Preterm UDdB.UDTT))] -> (UDdB.Preterm UDdB.UDTT) -> [UTree UJudgement]
...
-- piIntro :: TUEnv -> SUEnv -> (UDdB.Preterm UDdB.UDTT) -> [UTree UJudgement]
...
-- dismantle :: TUEnv -> TUEnv -> [((UDdB.Preterm UDdB.UDTT), (UDdB.Preterm UDdB.UDTT))] -> [((UDdB.Preterm UDdB.UDTT), (UDdB.Preterm UDdB.UDTT))]
...
--       case index of
--         Just k -> let preB' = UD.shiftIndices (UD.subst preB (UD.shiftIndices (UD.Proj {--  UD.Fst --} UDdB.Fst (UD.Var k)) 1 0) 0) (-1) 0 in
--                   dismantle env (preB':preA:xs) ((UD.Proj {--  UD.Snd --} UDdB.Snd (UD.Var k), preB'):(UD.Proj {--  UD.Fst --} UDdB.Fst (UD.Var k), preA):(UD.Var k, preterm):result)
--         Nothing -> let newTerm = search result preterm in
--                    case newTerm of
--                      Just term -> let preB' = UD.shiftIndices (UD.subst preB (UD.shiftIndices (UD.Proj {--  UD.Fst --} UDdB.Fst term) 1 0) 0) (-1) 0 in
--                                   dismantle env (preB':preA:xs) ((UD.Proj {--  UD.Snd --} UDdB.Snd term, preB'):(UD.Proj {--  UD.Fst --} UDdB.Fst term, preA):result)
--                      Nothing -> dismantle env xs result
--     _ -> dismantle env xs result
-- -- UD.subst preB (UD.Proj {--  UD.Fst --} UDdB.Fst term) 0
-- -- UD.subst preB (UD.Proj {--  UD.Fst --} UDdB.Fst (UD.Var k)) 0

-- -- | execute : シグネチャの中からPi型を見つけて投射をかける
-- -- | シグネチャはあらかじめchangeSigで型を変換しておく
-- execute :: [((UDdB.Preterm UDdB.UDTT), (UDdB.Preterm UDdB.UDTT))] -> [((UDdB.Preterm UDdB.UDTT), (UDdB.Preterm UDdB.UDTT))] -> [((UDdB.Preterm UDdB.UDTT), (UDdB.Preterm UDdB.UDTT))] -> [((UDdB.Preterm UDdB.UDTT), (UDdB.Preterm UDdB.UDTT))]
...
-- search :: [((UDdB.Preterm UDdB.UDTT), (UDdB.Preterm UDdB.UDTT))] -> (UDdB.Preterm UDdB.UDTT) -> Maybe (UDdB.Preterm UDdB.UDTT)
-- search [] _ = Nothing
...
-- dismantleSig :: [((UDdB.Preterm UDdB.UDTT), (UDdB.Preterm UDdB.UDTT))] -> [((UDdB.Preterm UDdB.UDTT), (UDdB.Preterm UDdB.UDTT))] -> [((UDdB.Preterm UDdB.UDTT), (UDdB.Preterm UDdB.UDTT))]
-- dismantleSig [] result = result
-- dismantleSig ((term, preterm):xs) result =
--   case preterm of
--     (UD.Sigma preA preB) ->
--       let preB' = UD.shiftIndices (UD.subst preB (UD.shiftIndices (UD.Proj {--  UD.Fst --} UDdB.Fst term) 1 0) 0) (-1) 0 in
--       dismantleSig ((UD.Proj {--  UD.Fst --} UDdB.Fst term, preA):(UD.Proj {--  UD.Snd --} UDdB.Snd term, preB'):xs) ((term, preterm):result)
--     _ -> dismantleSig xs ((term, preterm):result)


-- -- | changeSig : dismantleSigの補助関数
-- -- | シグネチャの型を変更
-- changeSig :: SUEnv -> [((UDdB.Preterm UDdB.UDTT), (UDdB.Preterm UDdB.UDTT))] -> [((UDdB.Preterm UDdB.UDTT), (UDdB.Preterm UDdB.UDTT))]
...
-- -- | 型環境の型を変更
-- changeTenv :: TUEnv -> TUEnv -> [((UDdB.Preterm UDdB.UDTT), (UDdB.Preterm UDdB.UDTT))] -> [((UDdB.Preterm UDdB.UDTT), (UDdB.Preterm UDdB.UDTT))]
...
-- searchIndex :: (UDdB.Preterm UDdB.UDTT) -> TUEnv -> TUEnv -> [Int] -> [Int]
...
-- make :: (UDdB.Preterm UDdB.UDTT) -> (UDdB.Preterm UDdB.UDTT) -> (UDdB.Preterm UDdB.UDTT) -> ((UDdB.Preterm UDdB.UDTT), (UDdB.Preterm UDdB.UDTT))
