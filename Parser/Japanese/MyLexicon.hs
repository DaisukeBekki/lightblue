...
emptyCategories = [
  ...
  ec "\\emp" "(730)" 100
              ...
              ((Lam (Lam (Lam (App (Var 1) (Lam (Sigma entity (Sigma (App (App (Con "＃manner") (Var 0)) (Var 1)) (Sigma (App (App (Var 5) (Var 1)) (Lam Top)) (App (Var 4) (Var 3)))))))))), [("＃様態",Pi entity (Pi event Type))]),
  -- 形容詞の様態副詞用法: 
  ec "\\emp" "(730)+" 100
